...
This bundle is self-contained: it seeds a small sample of the repo's own
TRAINING_DS.csv into LIB2023.TRAINING_DS1 (the library the full program reads),
then runs the univariate PROC FREQ analysis on the categorical variables.
**********************************************************************************************/
